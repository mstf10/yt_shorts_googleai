    ...
    <div className="w-full px-4 sm:px-6 py-6 space-y-6">
      ...
      <div className="bg-slate-900 border border-slate-800 p-5 rounded-2xl space-y-3">
        ...
        <div className="text-xs text-slate-400 leading-relaxed space-y-2">
          ...
          <p>
            • <strong className="text-slate-200">Otomatik Yedek Seslendirme (Edge TTS Fallback):</strong> Gemini TTS seslendirme modellerinde kota aşımı (429) veya geçici bir sorun yaşanması durumunda sistem kesintisiz olarak Microsoft Edge Read Aloud (Edge TTS) motoruna geçerek yüksek kaliteli seslendirme oluşturmaya devam eder.
          </p>
          <p>
